        ...
        <Layout>
            <div className='container'>
                <Toaster
                    ...
                    reverseOrder={false}
                />
                <h1 className='title lg text-font_color'>ประวัติการแจ้งชำรุดครุภัณฑ์</h1>
                <div className='flex flex-col gap-4 mt-8'>
                    <div className='flex justify-between items-start'>
                        ...
                        <div className='flex gap-3'>
                            <button onClick={() => openModalChangeStatus()} className='bg-primary_1 whitespace-nowrap hover:bg-dark rounded-lg flex items-center gap-2 px-6  text-white w-fit transition-all min-h-[40px]'>
                                <span>เปลี่ยนสถานะครุภัณฑ์</span>
                            </button>
                            <button onClick={() => openModalInsert()} className='bg-primary_1 whitespace-nowrap hover:bg-dark rounded-lg flex items-center gap-2 px-6  text-white w-fit transition-all min-h-[40px]'>
                                <span>แจ้งชำรุด</span>
                            </button>
                        </div>
                    </div>
