...
const SourceMoney: React.FC = () => {
    ...
    const [data, setData] = useState([
        { id: 1, source_money: 'source_money 1' },
        { id: 2, source_money: 'source_money 2' },
        { id: 3, source_money: 'source_money 3' },
        { id: 4, source_money: 'source_money 4' },
        { id: 5, source_money: 'source_money 5' },
        { id: 6, source_money: 'source_money 6' },
        { id: 7, source_money: 'source_money 7' },
        { id: 8, source_money: 'source_money 8' },
    ]);
                            ...
                            {filteredData?.slice(
                                ...
                                <TableRow key={item.id}>
                                    ...
                                    <TableCell className='flex gap-2 justify-end' >
                                        ...
                                        <MdDelete className='text-red-600 cursor-pointer' onClick={() => handleDel(item.id, item.source_money)} size={20} />
                                    </TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
