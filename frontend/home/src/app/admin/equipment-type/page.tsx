...
const EquipmentTypePage: React.FC = () => {
    ...
    const [data, setData] = useState([
        { id: 1, equipment_type: 'equipment_type 1' },
        { id: 2, equipment_type: 'equipment_type 2' },
        { id: 3, equipment_type: 'equipment_type 3' },
        { id: 4, equipment_type: 'equipment_type 4' },
        { id: 5, equipment_type: 'equipment_type 5' },
        { id: 6, equipment_type: 'equipment_type 6' },
        { id: 7, equipment_type: 'equipment_type 7' },
        { id: 8, equipment_type: 'equipment_type 8' },
    ]);
                            ...
                            {filteredData?.slice(
                                ...
                                <TableRow key={item.id}>
                                    ...
                                    <TableCell className='flex gap-2 justify-end' >
                                        ...
                                        <MdDelete className='text-red-600 cursor-pointer' onClick={() => handleDel(item.id, item.equipment_type)} size={20} />
                                    </TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
