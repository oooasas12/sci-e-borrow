          ...
          <div className="flex justify-between">
            ...
            <div className="flex">
              <button
                ...
                className="flex w-fit items-center gap-2 rounded-lg bg-primary_1 px-6 text-white transition-all hover:bg-dark"
              >
              ...
              {...registerInsert("date_return", {
                ...
                validate: (value) => {
                  ...
                  return (
                    ...
                    "วันที่คืนต้องมากกว่าหรือเท่ากับตั้งแต่วันที่ยืม"
                  );
                },
              })}
            />
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            ...
            {errorsEdit.date_return && (
              <span className="text-sm text-red-500">
                {errorsEdit.date_return.message}
              </span>
            )}
          </div>
          <div className="flex flex-col gap-2">
